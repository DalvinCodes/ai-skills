...
### Collision Categories (v3.90+)

```javascript
// Per-body collision categories within groups
const CATEGORY = { PLAYER: 1, ENEMY: 2, BULLET: 4, WALL: 8 };

player.body.collisionCategory = CATEGORY.PLAYER;
player.body.collisionMask = CATEGORY.ENEMY | CATEGORY.WALL;

// Individual bodies in a group can have unique categories
